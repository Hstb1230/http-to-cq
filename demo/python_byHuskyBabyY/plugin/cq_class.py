...
class GetCoolQ (CoreCoolQ):
    ...
    def get_share_list(self, group_id) -> object:
        ...
        """
        arr = self.new_array('getShareList', group_id)
        return self.send_data(arr)
...
class SendCoolQ (GetCoolQ):
    ...
    def send_discuss_msg(self, group, msg) -> int:
        ...
        :return: 状态码
        """
        return self.send_msg('sendDiscussMsg', group, 0, msg)
    ...
    def send_flower(self, group, qq) -> int:
        ...
        :return: 状态码
        """
        return self.send_msg('sendFlower', group, qq)
    ...
    def send_group_msg(self, group, msg) -> int:
        ...
        :return: 状态码
        """
        return self.send_msg('sendGroupMsg', group, 0, msg)
    ...
    def send_like(self, qq, count=1) -> int:
        ...
        :return: 状态码
        """
        array = self.new_array('sendLike', 0, qq)
        array['number'] = count
        array = self.send_data(array)
        return array['status']
    ...
    def send_private_msg(self, qq, msg):
        ...
        :return: 状态码，0为成功
        """
        return self.send_msg('sendPrivateMsg', 0, qq, msg)
...
class SetCoolQ (SendCoolQ):
    ...
    def set_discuss_leave(self, group) -> int:
        ...
        :return: 状态码，0为成功
        """
        array = self.new_array('setDiscussLeave', group)
        return array['status']
    ...
    def set_friend_add_request(self, response_flag, sub_type, name='') -> int:
        ...
        :return: 状态码，0为成功
        """
        array = dict(fun='setFriendAddRequest', responseFlag=response_flag, subType=sub_type, name=name)
        array = self.send_data(array)
        return array['status']
    ...
    def set_group_add_request(self, response_flag, sub_type, _type, msg='') -> int:
        ...
        :return: 状态码，0为成功
        """
        array = dict(fun='setDiscussLeave', responseFlag=response_flag, subType=sub_type, type=_type, msg=msg)
        array = self.send_data(array)
        return array['status']
    ...
    def set_group_admin(self, group, qq, become=False) -> int:
        ...
        :return: 状态码，0为成功
        """
        array = self.new_array('setGroupAdmin', group, qq)
        array['become'] = become
        array = self.send_data(array)
        return array['status']
    ...
    def set_group_anonymous(self, group, _open=False) -> int:
        ...
        :return: 状态码
        """
        array = self.new_array('setGroupAnonymous', group)
        array['open'] = _open
        array = self.send_data(array)
        return array['status']
    ...
    def set_group_anonymous_ban(self, group, anonymous, time) -> int:
        ...
        :return: 状态码
        """
        array = self.new_array('setGroupAnonymousBan', group)
    ...
    def set_group_ban(self, group, qq, time=0) -> int:
        ...
        :return: 状态码
        """
        array = self.new_array('setGroupBan', group, qq)
        array['time'] = time
        array = self.send_data(array)
        return array['status']
    ...
    def set_group_card(self, group, qq, card=''):
        ...
        :return: 状态码
        """
        array = self.new_array('setGroupCard', group, qq)
        array['card'] = card
        array = self.send_data(array)
        return array['status']
    ...
    def set_group_leave(self, group, disband=False) -> int:
        ...
        :return: 状态码
        """
        array = self.new_array('setGroupLeave', group)
        disband = disband
    ...
    def set_group_kick(self, group, qq, refuse_join=False) -> int:
        ...
        :return: 状态码
        """
        array = self.new_array('setGroupKick', group, qq)
    ...
    def set_group_sign(self, group=0) -> int:
        ...
        """
        array = self.new_array('setGroupSign', group)
        array = self.send_data(array)
        return array['status']
    ...
    def set_group_special_title(self, group, qq, tip='', time=-1) -> int:
        ...
        :return: 状态码
        """
        arr = self.new_array('setGroupSpecialTitle', group, qq)
        arr['tip'] = tip
        arr['time'] = time
    ...
    def set_group_whole_ban(self, group, _open=False) -> int:
        ...
        :return: 状态码
        """
        arr = self.new_array('setGroupWholeBan', group)
        arr['open'] = _open
        arr = self.send_data(arr)
        return arr['status']
    ...
    def set_sign(self) -> object:
        ...
        """
        return self.get_no_param_return('setSign')
